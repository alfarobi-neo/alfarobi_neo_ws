...
#ifdef NASIONAL
    field_bg_path << ros::package::getPath("alfarobi_monitor") << "/icon/localization_monitor/field_background.jpg";
#else
    field_bg_path << ros::package::getPath("alfarobi_monitor") << "/icon/localization_monitor/field_background_regional.jpg";
#endif
...
void DataViewer::drawProjectedLines(){
    ...
    for(std::vector<alfarobi_msgs_srvs_actions::Feature>::iterator it=features_.feature.begin();
