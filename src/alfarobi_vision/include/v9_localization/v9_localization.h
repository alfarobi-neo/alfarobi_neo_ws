...
#include "alfarobi_msgs_srvs_actions/LineTip.h"
#include "alfarobi_msgs_srvs_actions/FieldBoundary.h"
...
typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::Image,
                                                        sensor_msgs::Image,
                                                        alfarobi_msgs_srvs_actions::FieldBoundary,
...
private:
    ...
    message_filters::Subscriber<alfarobi_msgs_srvs_actions::FieldBoundary > fb_sub_;
...
//#endif
    ...
    alfarobi_msgs_srvs_actions::FieldBoundary field_boundary_;
...
#endif
    void publishTipPoints(alfarobi_msgs_srvs_actions::LineTip _tip_points);

    int getIntersectionType(const cv::Mat &_intersect_roi, const cv::Vec2f _model[2],const cv::Point &_center);

    alfarobi_msgs_srvs_actions::Features getLineIntersection(Vectors3 _line_models);
    ...
    void saveParams(){
        ...
        std::ofstream file_out(ros::package::getPath("alfarobi_vision") + "/config/v9_localization/saved_params.yaml");
