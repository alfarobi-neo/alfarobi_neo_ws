...
private:
    ...
    */
    ...
    void lutCallback(const alfarobi_msgs_srvs_actions::LUTConstPtr &_msg);
    ...
    */
    ...
    std::pair<cv::Mat, alfarobi_msgs_srvs_actions::FieldBoundary> getFieldImage(const cv::Mat &_segmented_green);
