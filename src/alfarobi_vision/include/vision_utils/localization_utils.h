...
public:
    ...
    void scanLinePoints(cv::Mat _invert_green, cv::Mat _segmented_white , const alfarobi_msgs_srvs_actions::FieldBoundary &_field_boundary,
              Points &_target_points, int _orientation);
    //overload scanLinePoints function
    void scanLinePoints(const cv::Mat &_invert_green, const cv::Mat &_segmented_white , const alfarobi_msgs_srvs_actions::FieldBoundary &_field_boundary,
