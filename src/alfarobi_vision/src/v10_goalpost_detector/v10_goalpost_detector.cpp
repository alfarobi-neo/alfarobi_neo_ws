...
//baru
    ...
    nh_.param<std::string>("goalpost_config_path", goalpost_config_path,
                           ros::package::getPath("alfarobi_vision") + "/config/v10_goalpost_detector/saved_config.yaml");
...
void GoalpostDetector::loadParam(){
    ...
    goalpost_ref_ = cv::imread(ros::package::getPath("alfarobi_vision") + "/config/v10_goalpost_detector/goalpost_ref.jpg");
...
void GoalpostDetector::saveParam(){
    ...
    cv::imwrite(ros::package::getPath("alfarobi_vision") + "/config/v10_goalpost_detector/goalpost_ref.jpg", goalpost_ref_);
}
