...
//baru
    ...
    nh_.param<std::string>("ball_config_path", ball_config_path,
                           ros::package::getPath("alfarobi_vision") + "/config/v9_ball_detector/saved_config.yaml");
...
void BallDetector::loadParam(){
    ...
    ball_ref_ = cv::imread(ros::package::getPath("alfarobi_vision") + "/config/v9_ball_detector/ball_ref.jpg");
...
void BallDetector::saveParam(){
    ...
    cv::imwrite(ros::package::getPath("alfarobi_vision") + "/config/v9_ball_detector/ball_ref.jpg", ball_ref_);
}
...
void BallDetector::lineTipCallback(const alfarobi_msgs_srvs_actions::LineTipConstPtr &_msg){
