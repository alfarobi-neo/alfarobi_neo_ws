...
def parse_args(arguments=None):
    ...
    parser.add_argument(
        "--model_filepath",
        default='/home/alfarobi/alfarobi_neo_ws_/src/alfarobi_vision/src/python_img_sub/weight/best_10april.onnx',
        type=str,
        help=(
    ...
    mn_path  = os.path.join(os.getenv('HOME'), '/.ros')

    if(os.getcwd() == mn_path):
        parser.add_argument('__names', type=str, default=None)
...
def annotate(args, loader):
    ...
    for iteration, (inp, source_img) in enumerate(loader):
        ...
        # annotate
        measured_fps = (
            args.target_fps or (1.0 / (time.time() - iter_start))
        )
